...
public class Photo
    ...
    private boolean settingLike = false;
     ...
     */
    private RelatedPhotos related_photos;
     ...
     */
    private RelatedCollections related_collections;
    ...
    public int getRegularWidth() {
        try {
            int w = Integer.parseInt(Uri.parse(urls.getRegular()).getQueryParameter("w"));
            return w == 0 ? 1600 : 1600;//w;
    ...
    public String getWallpaperSizeUrl(Context context) {
        ...
        return urls.getRaw() + "?q=50&fm=jpg&w=" + w + "&h=" + h + "&fit=crop";
    }
    ...
    protected Photo(Parcel in) {
        ...
        this.user = in.readParcelable(PhotoUrls.class.getClassLoader());
    ...
    public void setLoadPhotoSuccess(boolean loadPhotoSuccess) {
        this.loadPhotoSuccess = loadPhotoSuccess;
    }
    ...
    public void setSettingLike(boolean settingLike) {
        this.settingLike = settingLike;
    }
    ...
    public List<Collection> getCurrent_user_collections() {
        return current_user_collections;
    }

    public void setCurrent_user_collections(List<Collection> current_user_collections) {
    ...
    public RelatedPhotos getRelated_photos() {
        return related_photos;
    }

    public void setRelated_photos(RelatedPhotos related_photos) {
        this.related_photos = related_photos;
    }

    public RelatedCollections getRelated_collections() {
        return related_collections;
    }

    public void setRelated_collections(RelatedCollections related_collections) {
