package team.hex.wallpaper.api.service;
...
import team.hex.wallpaper.api.util.AuthInterceptor;
import team.hex.wallpaper.api.util.OfflineCacheInterceptor;
import team.hex.wallpaper.application.AppController;

import static team.hex.wallpaper.common.BuildConfigs.BASE_URL;
import static team.hex.wallpaper.common.BuildConfigs.DATE_FORMAT;
